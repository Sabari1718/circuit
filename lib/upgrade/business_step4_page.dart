...
import 'business_step5_page.dart';
import '../widgets/common_dashboard_app_bar.dart';

class BusinessStep4Page extends StatefulWidget {
  const BusinessStep4Page({super.key});

  @override
  State<BusinessStep4Page> createState() => _BusinessStep4PageState();
}

class _BusinessStep4PageState extends State<BusinessStep4Page> {
  ...
  void _handleNext() {
    if (_formKey.currentState!.validate()) {
      Navigator.push(context, MaterialPageRoute(builder: (context) => const BusinessStep5Page()));
    }
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Step 4: Contact links", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFF1E293B))),
              const SizedBox(height: 32),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration("Enter business phone", Icons.phone_outlined),
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration("Enter business email", Icons.email_outlined),
