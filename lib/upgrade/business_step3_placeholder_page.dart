...
class BusinessStep3PlaceholderPage extends StatelessWidget {
  const BusinessStep3PlaceholderPage({super.key});
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.construction_rounded, size: 64, color: Color(0xFF94A3B8)),
            ),
            ...
            const Text(
              "We are building this experience for you.",
