...
class _CreateBusinessUserPageState extends State<CreateBusinessUserPage> {
    ...
    child: Column(
      ...
      children: [
        ...
        _buildFormCard([
          ...
          _buildInputField('Email *', _emailCtrl, isDark),
          _buildInputField(
            'Phone *',
            _phoneCtrl,
            isDark,
          ...
          _buildInputField('PAN Number *', _panCtrl, isDark),
          _buildFileUpload(
            'PAN Photo *',
            _panFileName,
            _panBytes,
  ...
  Widget _buildStep3(bool isDark) => Form(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildHeading('Bank Details', 'Current account info', isDark),
        _buildFormCard([
          _buildInputField('Account Number *', _accNumberCtrl, isDark),
          _buildInputField('Confirm Number *', _confirmAccNumberCtrl, isDark),
          _buildInputField('IFSC Code *', _ifscCtrl, isDark),
          _buildInputField('Bank Name *', _bankNameCtrl, isDark),
          _buildInputField('Holder Name *', _holderNameCtrl, isDark),
          const SizedBox(height: 16),
          Text(
            'Document Type *',
            style: TextStyle(
  ...
  Widget _buildStep4(Color color, bool isDark) => Form(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildHeading('Address', 'Headquarters location', isDark),
        _buildFormCard([
          Row(
            children: [
              Expanded(child: _buildInputField('Door *', _doorCtrl, isDark)),
              const SizedBox(width: 16),
              Expanded(
                child: _buildInputField('Street *', _streetCtrl, isDark),
              ),
            ],
          ),
          const SizedBox(height: 16),
          _buildInputField('Building', _buildingCtrl, isDark),
          const SizedBox(height: 16),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                ElevatedButton(
                  onPressed: () => _autofillPincode(_pincodeCtrl.text),
          ...
          const SizedBox(height: 20),
          _buildInputField('Area *', _areaCtrl, isDark),
          Row(
            children: [
              Expanded(
                child: _buildInputField('District *', _districtCtrl, isDark),
              ),
              const SizedBox(width: 16),
  ...
  Widget _buildStep5(Color color, bool isDark) {
    ...
    return Column(
      ...
      children: [
        _buildHeading(
          'Business Type',
          'Configure business classification',
          isDark,
        ),
        GridView.builder(
          shrinkWrap: true,
  ...
  Widget _buildStep6(Color color, bool isDark) {
    ...
    final subCategories =
        ...
        ? (_categoriesData[_selectedSectorTitle]![_selectedSector]![_selectedSubSector]![_activePrimaryCategory] ??
              <String>[])
        : <String>[];
    ...
    return Column(
      ...
      children: [
        _buildHeading(
          'Categories',
          'Select business sectors & categories',
          isDark,
        ),
        SearchableDropdown(
          label: 'Sector Title *',
