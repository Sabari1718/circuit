...
void main() async {
  ...
  final t1 = '''            String salary = item['monthly_salary']?.toString() ?? '';
            String salaryRange = salary.isNotEmpty
                ? '\$salary USD'
                : 'Not Specified';''';
  final r1 = '''            String salary = item['monthly_salary']?.toString() ?? '';
            String salaryRange = salary.isNotEmpty
                ? '\$salary INR'
                : 'Not Specified';
  ...
  final t2 = '''                description: _getFirstValid(
                  [item['job_description']],
                  'No description available',
                ),
                skills: [],''';
  final r2 = '''                description: _getFirstValid(
                  [item['job_description']],
                  'No description available',
                ),
                skills: parsedSkills,''';
  ...
  final t3 = '''  Widget _buildViewDetailsBtn(PostedJobModel job, bool isDark) {
    return InkWell(
  ...
  final r3 = '''  Widget _buildViewDetailsBtn(PostedJobModel job, bool isDark) {
    return InkWell(
      onTap: () => _showJobDetails(job),
      borderRadius: BorderRadius.circular(16),
      child: Container(
  ...
  final startIdx = content.indexOf('  void _showJobDetails(PostedJobModel job) {');
  final endIdx = content.indexOf('class _HeaderCell extends StatelessWidget {');
  ...
  final newDialog = '''  void _showJobDetails(PostedJobModel job) {
    showDialog(
      context: context,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Icon(Icons.star, size: 18, color: Color(0xFF4F46E5)),
                            const SizedBox(width: 8),
                            Text(
                              "Required Skills",
                              style: TextStyle(
...
''';
  ...
  content = content.replaceRange(startIdx, endIdx, newDialog);
